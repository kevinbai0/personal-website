...
function (_Component) {
  ...
  function WorkPage(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "scrollListener", function () {
      _this.setState({
        scrollOffset: window && window.pageYOffset
      });
    });
    ...
    _this.state = {
      ...
      featuredWork: [{
        ...
        src: "/assets/portfolio/molarmass.png",
        style: (_style = {
          background: "#aaffa9"
        ...
        src: "/assets/portfolio/falcotronix.png",
        style: (_style2 = {
          background: "#7F7FD5"
...
//# sourceMappingURL=work.js.64e8f7eee60c297f7bf8.hot-update.js.map